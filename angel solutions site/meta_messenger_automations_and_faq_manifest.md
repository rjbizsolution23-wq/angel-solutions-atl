...
```
   ...
   (Is it spam/offensive?)            (Check Escalation Triggers)
    - Yes ➔ Hide Comment               - Yes ➔ Turn Off Bot & Alert Rick
...
*   **Day 8 Legal Rights (FCRA)**:
    > "Rick here! Just a quick credit tip: Under FCRA 15 U.S.C. § 1681, you have the legal right to dispute any inaccurate, incomplete, or unverified item on your report. We make sure the bureaus respect that! Let's get started: https://angelsolutionsatl.com/book-online"
...
### 2. Escalation Notification to Rick
*   **Trigger**: High-priority handoff keyword match.
*   **SMS Sent to Rick (+14703386689)**:
