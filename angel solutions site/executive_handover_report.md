...
*   **Staff Escalation**: The system sends a GHL CRM tag update to `Needs Human Interaction` and dispatches an alert, allowing Rick or her team to chat manually in the inbox without interference.
