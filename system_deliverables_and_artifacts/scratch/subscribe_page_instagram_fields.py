...
try:
    ...
    with urllib.request.urlopen(req) as response:
        ...
        # Now, subscribe the page to the app with the specific instagram_messages and other instagram fields!
        # Standard page webhook fields for Instagram integration:
        # instagram_messages (crucial for DMs)
        # instagram_comments (for public comments)
        # instagram_mentions (for story mentions)
        print("\nSubscribing Page to instagram_messages and other fields...")
        sub_url = f"https://graph.facebook.com/v19.0/{page_id}/subscribed_apps?access_token={page_token}"
        
        # We merge all existing fields with the new instagram fields to be safe, or just provide the full list.
        fields = [
            "message_deliveries",
            "message_edits",
            "message_reactions",
